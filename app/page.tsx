          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 max-w-3xl mx-auto">
              <Link href="/games" className="w-full group">
                <Button
                  size="lg"
                  className="magical-button animated-button-colors w-full bg-gradient-to-br from-blue-400 via-cyan-400 to-blue-500 hover:from-blue-500 hover:via-cyan-500 hover:to-blue-600 text-xl sm:text-2xl md:text-3xl px-6 py-6 sm:py-10 md:py-12 font-bold shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 rounded-2xl"
                >
                  <Gamepad2 className="w-6 h-6 sm:w-7 sm:h-7 mb-1 group-hover:animate-bounce" />
                  <span className="block text-white font-serif [text-shadow:_3px_3px_6px_rgb(0_0_0_/_90%),_-2px_-2px_4px_rgb(0_0_0_/_70%),_0_0_10px_rgb(0_0_0_/_50%)]">
                    Games
                  </span>
                </Button>
              </Link>
              ...
              <Link href="/rules" className="w-full group">
                <Button
                  size="lg"
                  className="magical-button animated-button-colors w-full bg-gradient-to-br from-purple-400 via-pink-400 to-purple-500 hover:from-purple-500 hover:via-pink-500 hover:to-purple-600 text-xl sm:text-2xl md:text-3xl px-6 py-6 sm:py-10 md:py-12 font-bold shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 rounded-2xl"
                >
              ...
              <Link href="/contact" className="w-full group">
                <Button
                  size="lg"
                  className="magical-button animated-button-colors w-full bg-gradient-to-br from-green-400 via-emerald-400 to-green-500 hover:from-green-500 hover:via-emerald-500 hover:to-green-600 text-xl sm:text-2xl md:text-3xl px-6 py-6 sm:py-10 md:py-12 font-bold shadow-xl hover:shadow-2xl transition-all transform hover:scale-105 rounded-2xl"
                >
